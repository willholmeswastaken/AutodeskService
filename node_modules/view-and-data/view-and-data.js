...
module.exports = function(config) {
  ...
  _self.getToken = function() {
      ...
      //The current npm version doesnt do the correct scoping, so if you leave it on the join,
      //it will not set the scope for the other tests. So to get round it define them manually.
    var params = {
